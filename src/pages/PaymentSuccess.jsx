...
const PaymentSuccess = () => {
  ...
  useEffect(() => {
    // Simulate loading for a short time to show the success message
    ...
    <div className="min-h-screen pt-36 pb-16 bg-base dark:bg-darkBase flex items-center">
      <div className="w-11/12 mx-auto max-w-3xl">
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white mb-4">Payment Successful!</h1>

          <p className="text-xl text-green-600 dark:text-green-400 mb-2">Thank you for your subscription</p>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 mb-8 text-left">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">{tran_id}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">{card_type}</span>
              </div>
              <div className="flex justify-between">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Your subscription is now active! You can now enjoy unlimited book tracking and all premium features.
          </p>
